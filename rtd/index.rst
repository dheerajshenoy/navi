...
`Project Gitlab mirror <https://gitlab.com/dheerajshenoy/navi>`_

`Project Website <https://dheerajshenoy.github.io/navi>`_

Key Features:

    + **Performance-Oriented**: Built with C++ for optimal speed and responsiveness.
    ...
    + **Extensibility**: Supports plugins (TODO) and scripts for added functionality.
...
Navi uses the following C++ libraries. Thanks to the authors of the following libraries:

- `Qt <https://www.qt.io/product/qt6>`_ (for GUI)
...
- `ffmpegthumbnailer <https://github.com/dirkvdb/ffmpegthumbnailer>`_ (for thumbnailiing video files)
