...
void Navi::initNaviLuaAPI() noexcept {
    ...
    // ItemProperty type
    lua.new_usertype<FilePanel::ItemProperty>("ItemProperty",
                                              "name", &FilePanel::ItemProperty::name,
                                              "size", &FilePanel::ItemProperty::size,
                                              "mimeName", &FilePanel::ItemProperty::mimeName);
