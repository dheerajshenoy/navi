...
public:
    ...
    inline std::string get_header_stylesheet() noexcept {
        return m_file_panel->get_header_stylesheet();
    }
    ...
    inline std::string get_vheader_stylesheet() noexcept {
        return m_file_panel->tableView()->vheader()->styleSheet().toStdString();
    }
...
protected:
  ...
  private:
    ...
    new KDDockWidgets::QtWidgets::DockWidget(QStringLiteral("Preview Panel"));
    KDDockWidgets::QtWidgets::DockWidget *m_file_panel_dock =
    new KDDockWidgets::QtWidgets::DockWidget(QStringLiteral("File Panel"));
